...
from peck.ir.cfgutils import CfgSimple
from peck.solidity.utils import of_type, find, __, unzip2
from peck.solidity.v_0_5_x import solidity_grammar as ast
from peck.solidity.v_0_5_x.solidity_utils import deepcopy_with_mapping
...
def main():
    from peck.solidity import compile_attributed_ast_from_string, get_solidity_grammar_instance
